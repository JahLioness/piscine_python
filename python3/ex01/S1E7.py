...
class Baratheon(Character):
    """Class inheriting from abstract Class Character,
     representing the Baretheon family."""
    def __init__(self, first_name: str, is_alive: bool = True):
        """Initialize the Baretheon character with
         a name and alive status (default True)."""
...
class Lannister(Character):
    ...
    def __init__(self, first_name: str, is_alive: bool = True):
        """Initialize the Lannister character with
         a name and alive status (default True)."""
        self.first_name = first_name
        self.is_alive = is_alive
